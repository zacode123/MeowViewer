    ...
    <header className="bg-white shadow-md py-4">
      <div className="container mx-auto px-[24px]">
        <div className="flex justify-between items-center">
          ...
          <p className="absolute right-2 top-1/2 -translate-y-1/2 text-sm md:text-base font-semibold bg-gradient-to-r from-[#FF4081] to-purple-500 text-transparent bg-clip-text z-10">✨ Discover adorable cat images ✨</p>
        </div>
      </div>
    </header>
  );
